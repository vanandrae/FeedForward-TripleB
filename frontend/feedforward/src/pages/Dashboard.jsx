    ...
    <div className="min-h-screen bg-gray-50 p-6">
      ...
      <div className="bg-white rounded-lg shadow p-4 mb-6">
        <div className="flex justify-between mb-2">
          <h3 className="font-semibold text-gray-700">Resolution Progress</h3>
          <span className="text-blue-600 font-semibold">0%</span>
        </div>
        <div className="w-full bg-gray-200 rounded-full h-2">
          <div className="dashboard-progress-bar bg-gradient-to-r from-green-500 to-emerald-500 h-2 rounded-full" style={{ width: '0%' }}></div>
        </div>
        <p className="text-sm text-gray-500 mt-2">0 of 0 feedback items resolved</p>
      </div>
      ...
      <div className="mb-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          <div className="bg-white p-4 rounded-lg shadow border hover:shadow-lg transition cursor-pointer">
